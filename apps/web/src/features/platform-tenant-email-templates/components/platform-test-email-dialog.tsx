...
import { usePlatformSendTenantTestEmail } from '../use-platform-tenant-email-templates';
...
export function PlatformTestEmailDialog({
  tenantId,
  type,
  onClose,
}: {
  ...
  const sendTest = usePlatformSendTenantTestEmail(tenantId);

  return (
    <Dialog open onClose={onClose} title="Enviar correo de prueba">
      <div className="space-y-3">
        <div className="space-y-1">
          <Label htmlFor="platform-test-email-to">Correo de destino</Label>
          <Input
            id="platform-test-email-to"
            type="email"
